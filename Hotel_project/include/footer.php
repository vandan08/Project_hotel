        <div class="container-fluid bg-white1 mt-5 ">
            <div class="row">
        ...
        <h6 class="text-center bg-dark text-white p-3 m-0"> Dsigned & Developed By Team_VSK</h6>
        ...
        let xhr = new XMLHttpRequest();
            ...
            xhr.onload = function () {
                if (this.responseText=='pass_mismatch') {
                    ...
                    alert('success','Registration Succesful.');
                    register_form.reset();
    ...
    login_form.addEventListener('submit',function(e){
        ...
        modal.hide();
            ...
            xhr.onload = function () {
                ...
                //     alert('error','User Is not verified yet');
                // }
                else if (this.responseText=='inactive') {
                    alert('error','Account Suspended ! pls Contact Admin.');
                } else if (this.responseText=='invalid_pass') {
                    alert('error','Incorrect Password ');
                } else {
                    let file_url = window.location.href.split('/').pop().split('?').shift();
                    if (file_url == 'room_details.php') {
        ...
        let xhr = new XMLHttpRequest();
            ...
            xhr.onload = function () {
                ...
                // }
                    ...
                    var recoverPassButton = document.getElementById('recover_pass');
                    // Add the attributes to the element
                    recoverPassButton.setAttribute('data-bs-target', '#recoverymodal');
                    recoverPassButton.setAttribute('data-bs-dismiss', 'modal');
